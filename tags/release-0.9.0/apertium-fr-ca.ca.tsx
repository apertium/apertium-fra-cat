...
<tagset>
 ...
 <!--   <label-sequence>
  ...
  <preferences>
   ...
   <prefer tags="vbhaver.pii.3.sg"/>
   <prefer tags="vbmod.pii.3.sg"/>
   <prefer tags="vblex.prs.3.sg"/>
   <prefer tags="vbser.prs.3.sg"/>
   <prefer tags="vbhaver.prs.3.sg"/>
   <prefer tags="vbmod.prs.3.sg"/>
   <prefer tags="vblex.cni.3.sg"/>
   <prefer tags="vbser.cni.3.sg"/>
   <prefer tags="vbhaver.cni.3.sg"/>
   <prefer tags="vbmod.cni.3.sg"/>
   <prefer tags="vblex.pis.3.sg"/>
   <prefer tags="vbser.pis.3.sg"/>
   <prefer tags="vbhaver.pis.3.sg"/>
   <prefer tags="vbmod.pis.3.sg"/>
  </preferences>
</tagger>
